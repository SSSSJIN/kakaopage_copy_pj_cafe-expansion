...
<div class="header-bar">
  <div class="header-inner">
    ...
    <div class="nav">
      ...
      <a href="${pageContext.request.contextPath}/ranking" class="nav-link" style="font-size:16px; color:#4267b2; font-weight:500; text-decoration:none;">
      	실시간 랭킹
      </a>
    ...
    <div class="right-area">
      ...
      <a href="<%= (user == null) ? (request.getContextPath() + "/login") : (request.getContextPath() + "/library") %>" class="library-link" title="보관함">
